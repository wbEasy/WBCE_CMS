...
$module_description = "Admin-Tool um OutputFilter zu verwalten";
...
$LANG['MOD_OPF']['TXT_PAGE_HIERARCHY'] = 'Seite + Unterseiten';
...
$LANG['MOD_OPF']['TXT_DOCUMENTATION'] = 'Dokumentation';
$LANG['MOD_OPF']['TXT_DOCUMENTATION_OPEN'] = 'Dokumentation &ouml;ffnen';

// Tab-Beschriftungen fuer das Dokumentations-Popup (MdReaderLink::docs(), tool_dashboard.php)
$LANG['MOD_OPF']['TXT_DOC_OVERVIEW']  = '&Uuml;bersicht';
$LANG['MOD_OPF']['TXT_DOC_USER']      = 'Handbuch';
$LANG['MOD_OPF']['TXT_DOC_DEVELOPER'] = 'Entwicklerhandbuch';
$LANG['MOD_OPF']['TXT_DOC_API']       = 'API-Referenz';
