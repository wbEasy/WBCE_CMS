...
$TEXT['ICON'] = 'Symbol';
$TEXT['IMAGE'] = 'Bild';
$TEXT['INFO_INSTALL_LANGUAGE'] = 'Um eine Sprache zu installieren oder zu aktualisieren, Sprachdatei (z.B. DE.php) und Flaggenicon (z.B. DE.png) <strong>via FTP</strong> nach /languages kopieren. Dann auf den "Neu laden"-Button klicken.';
...
$TEXT['OF'] = 'von';
$TEXT['OLDWBCE'] = '<b style="color:red">WBCE CMS-Aktualisierung verfügbar, bitte updaten auf Version  </b>';
$TEXT['ON'] = 'am';
$TEXT['OPEN'] = 'öffnen';
$TEXT['OPTION'] = 'Option';
$TEXT['OTHERS'] = 'Alle';
...
$MESSAGE['START_WB_URL_SLASH'] = 'Bitte den Schrägstrich am Ende von WB_URL in der config.php entfernen!';
