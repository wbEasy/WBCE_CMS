...
$TEXT['NAME'] = 'Name';
$TEXT['NEED_CURRENT_PASSWORD'] = 'Please confirm the changes with your current password before submitting the form';
...
$TEXT['OF'] = 'Of';
$TEXT['OLDWBCE'] = '<b style="color:red">New version of WBCE CMS is available, please update to </b>';
$TEXT['ON'] = 'On';
$TEXT['OPEN'] = 'Open';
$TEXT['OPTION'] = 'Option';
$TEXT['OTHERS'] = 'Others';
...
$TEXT['PAGE_LANGUAGES'] = 'Multilingual website';
...
$MESSAGE['ADMIN_INSUFFICIENT_PRIVELLIGES'] = 'Insufficient privileges to be here';
...
$MESSAGE['PREFERENCES_CURRENT_PASSWORD_INCORRECT'] = 'The password you entered is incorrect. <br /><b>You need to confirm with your current password</b>.';
...
$MESSAGE['START_WB_URL_SLASH'] = 'Please remove the trailing slash from WB_URL in config.php file!';
...
$MESSAGE['USERS_CHANGING_PASSWORD'] = 'Please note: only enter values in the above fields if you want to change the password';
