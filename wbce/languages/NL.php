...
$MESSAGE['GENERIC_INVALID_ADDON_FILE'] = 'Ongeldig WBCE CMS installatiebestand. Controleer het *.zip bestand.';
$MESSAGE['GENERIC_INVALID_LANGUAGE_FILE'] = 'Ongeldig WBCE CMS taalbestand. Controleer het tekstbestand.';
$MESSAGE['GENERIC_INVALID_MODULE_FILE'] = 'Ongeldig WBCE CMS modulebestand. Controleer het tekstbestand';
$MESSAGE['GENERIC_INVALID_TEMPLATE_FILE'] = 'Ongeldig WBCE CMS template-bestand. Controleer het tekstbestand';
...
$MESSAGE['GROUPS_CONFIRM_DELETE'] = 'Weet u zeker dat u de geselecteerde groep verwijderen wilt (Enkel groepen zonder gebruikers kunnen worden verwijderd)?';
...
$SIGNAL['ADDON_SECURITY_WARNING'] = 'CodeVet-melding voor %s "%s": opvallende maar niet-geblokkeerde code gevonden — controleer de bron.';
// ── Download
